...
#-----------------------------------------------------------------------------------
def Plot_Energy_Ranking_TopN(path_read_info_ALLState:str, TopN:int, path_save=False) -> None:
    #----------------------
    #read
    ...
    ax.tick_params(axis="y", labelsize = 20)#軸の大きさ
...
#-----------------------------------------------------------------------------------
def Plot_Energy_Ranking(path_read_info_ALLState:str, path_save=False) -> None:
    #----------------------
    #read
    info_ALLState_df = pd.read_csv(path_read_info_ALLState, index_col=None, header=0, sep=',', encoding="utf-8", dtype={"state":str,"E":float,"SS":bool,"RA":str,"next_state":str})
    #---------------------
...
#-----------------------------------------------------------------------------------
def Plot_Energy_Ranking_Heatmap_TopN(path_read_info_ALLState:str, TopN:int, path_save=False) -> None:
    #----------------------
    #read
    info_ALLState_df = pd.read_csv(path_read_info_ALLState, index_col=None, header=0, sep=',', encoding="utf-8", dtype={"state":str,"E":float,"SS":bool,"RA":str,"next_state":str})
